...
class SSHConsumer(WebsocketConsumer):
    def __init__(self, *args, **kwargs):
        ...
        ssh_infos = kwargs['id']
        ssh_infos = aes_decode("1234123412ABCDEF", ssh_infos)
        ...
        logger.info("ssh登陆信息:{0}".format(self.ssh_info_dict))
        self.chan = None
        self.ssh = None
